...
public class PrevPageButton implements GuiItem {
    ...
    public PrevPageButton(boolean hasPage, @NotNull PlayerLocale playerLocale,
        ...
        this.itemStack = gunGaleWiki.getItemStackUtils()
                                    .getItemStack(
                                            Material.valueOf(config.getString(hasPage ? Config.BUTTON_PREVPAGE_ALLOW_MATERIAL
                                                                                      : Config.BUTTON_PREVPAGE_DISALLOW_MATERIAL)),
                                            messages.getComponentMessage(playerLocale, Message.BUTTON_PREV_PAGE_NAME),
                                            messages.getComponentList(playerLocale, Message.BUTTON_PREV_PAGE_LORE),
                                            1,
                                            itemMeta -> {
                                                var cmd = config.getInt(hasPage ? Config.BUTTON_PREVPAGE_ALLOW_CMD
                                                                                : Config.BUTTON_PREVPAGE_DISALLOW_CMD);
