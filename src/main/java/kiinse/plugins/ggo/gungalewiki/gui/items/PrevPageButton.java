...
public class PrevPageButton implements GuiItem {
    ...
    public PrevPageButton(@NotNull PlayerLocale playerLocale,
        ...
        this.itemStack = gunGaleWiki.getItemStackUtils()
                                    .getItemStack(
                                            Material.valueOf(config.getString(Config.BUTTON_PREVPAGE_MATERIAL)),
                                            messages.getStringMessage(playerLocale, Message.BUTTON_PREV_PAGE_NAME),
                                            messages.getComponentList(playerLocale, Message.BUTTON_PREV_PAGE_LORE),
                                            1,
                                            itemMeta -> {
                                                var cmd = config.getInt(Config.BUTTON_PREVPAGE_CMD);
